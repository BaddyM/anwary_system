  ...
  const features = [
    {
      ...
      description:
        "Local experts guide you to hidden gems and authentic experiences",
    },
    {
      icon: Shield,
      title: "Safe & Secure",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center hidden">
            ...
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground">
                ...
                <p>
                  Our passion lies in discovering the world's hidden gems and
                  sharing them with adventurous souls who seek authentic,
                  transformative experiences. From ancient temples to pristine
                  beaches, bustling markets to serene mountains, we curate every
                  detail to perfection.
                </p>
              </div>
              <Button
                className="mt-8 gradient-gold text-forest hover:opacity-90 px-8 shadow-lg"
                asChild
              >
      ...
      <section className="py-20 bg-background">
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              From luxury accommodations to authentic cultural experiences, we
      ...
      <section className="py-20 bg-pearl">
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Discover some of our most sought-after destinations, each offering
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {isSuccess == true &&
              destinations.data.map((destination:Destination, index:number) => (
                <Card
                  key={index}
                  className={`overflow-hidden hover-lift travel-card transition-all duration-1000 ${
                    destinationsVisible
                ...
                <CardContent className="p-8">
                  <div className="flex mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-5 h-5 fill-gold-bright text-gold-bright"
                      />
                    ))}
                  </div>
                  ...
                  <div className="text-sm">
                    <div className="font-semibold text-forest text-base">
                      {testimonial.name}
                    </div>
      ...
      <section className="py-20 bg-pearl">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Let us create a personalized journey that exceeds your wildest
            dreams. Your perfect adventure is just one click away.
          </p>
