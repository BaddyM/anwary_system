  ...
  const values = [
    {
      ...
      description: "We live and breathe travel, sharing our passion with every journey we create."
    },
    {
      icon: Shield,
      title: "Trust & Safety",
    ...
    },
    {
      ...
      description: "We believe in genuine cultural immersion and meaningful connections."
    },
    {
      icon: Award,
      title: "Excellence",
  ...
  const teamMembers = [
    {
      name: "Sarah Thompson",
      role: "Founder & CEO",
      description: "20+ years in luxury travel with a passion for creating unforgettable experiences.",
      image: "/placeholder.svg"
    },
    {
      name: "Michael Rodriguez",
      role: "Head of Operations",
      description: "Expert in logistics and ensuring seamless travel experiences worldwide.",
      image: "/placeholder.svg"
    },
    {
      name: "Emma Chen",
      role: "Cultural Experience Curator",
      description: "Specialist in authentic cultural immersion and local partnerships.",
      image: "/placeholder.svg"
    }
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative py-32 gradient-hero text-white overflow-hidden">
        ...
        >
          ...
          <p className="text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed">
            For over two decades, we've been crafting extraordinary journeys that transform travelers 
            into storytellers, creating memories that last a lifetime.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <h2 className="text-4xl font-bold text-forest mb-6">Our Story</h2>
              <div className="space-y-6 text-lg text-muted-foreground">
                <p>
                  Anwary Travel was born from a simple belief: that travel has the power to transform lives. 
                  Founded in 2001 by a group of passionate explorers, we started as a small boutique agency 
                  with big dreams and an unwavering commitment to excellence.
                </p>
                <p>
                  What began as organizing trips for friends and family has grown into a globally recognized 
                  luxury travel company. Yet our core mission remains unchanged – to create authentic, 
                  transformative experiences that connect people with the world's most extraordinary destinations.
                </p>
                <p>
                  Today, we're proud to have facilitated over 25,000 journeys, earned 15 industry awards, 
                  and maintained a 98% satisfaction rate. But our greatest achievement isn't measured in 
                  numbers – it's in the smiles, stories, and lifelong memories we've helped create.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              These core principles guide every decision we make and every journey we craft for our travelers.
            </p>
          </div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-bold text-forest mb-6">Meet Our Team</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our passionate team of travel experts brings decades of combined experience 
              and an unwavering commitment to creating your perfect journey.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              These milestones represent years of dedication to creating exceptional travel experiences.
            </p>
          </div>
      ...
      <section className="py-20 bg-pearl">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Let our experienced team create a personalized adventure that reflects your unique travel dreams. 
            Your extraordinary journey begins with a simple conversation.
          </p>
