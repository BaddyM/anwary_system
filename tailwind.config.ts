  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-up": "slide-up 0.6s ease-out",
        ...
        "stagger-4": "slide-up 0.6s ease-out 0.4s both",
        "stagger-5": "slide-up 0.6s ease-out 0.5s both",
        "stagger-6": "slide-up 0.6s ease-out 0.6s both"
      },
    },
  },
